...
Overall, this project demonstrates your skills in working with APIs, JavaScript, and web development in general. The use of vanilla JavaScript allows for a lightweight and fast-performing application, without the need for any additional JavaScript frameworks. It's a great addition to my portfolio to show my ability to create a functional web application from scratch.
...
Check out the live demo of the application at https://ankur261.github.io/Meal%20World/

## Authors

- [@Ankur261](https://github.com/Ankur261)
